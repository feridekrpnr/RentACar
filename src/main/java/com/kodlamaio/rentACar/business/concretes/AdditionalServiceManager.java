...
public class AdditionalServiceManager implements AdditionalServiceService {
	...
	public Result update(UpdateAdditionalServiceRequest updateAdditionalServiceRequest) {
		AdditionalService addServiceToUpdate = mapper.forRequest().map(updateAdditionalServiceRequest,
				AdditionalService.class);
	...
	public DataResult<List<GetAllAdditionalServicesResponse>> getAll() {
		...
		List<GetAllAdditionalServicesResponse> response = items.stream()
				.map(item -> this.mapper.forResponse().map(item, GetAllAdditionalServicesResponse.class))
